...
import io.ghap.reporting.annotations.DefaultBootstrap;
...
import io.ghap.reporting.data.MockReportFactoryImpl;
...
@DefaultBootstrap
public class ReportingBootstrap extends JerseyServletModule {
  @Override
