...
<%
    ...
    // BUT "renderingManager" SHARED TOO
    Properties initialWikiProperties = engine.getWikiProperties();
    try {
        Properties copyOfWikiProperties = new Properties();
        copyOfWikiProperties.putAll( initialWikiProperties );
...
<%
        ...
        renderingManager.initialize( engine, initialWikiProperties );
    }
%>