    ...
    public ContainerResponse filter(ContainerRequest request, ContainerResponse response) {
        ...
        if(null != reqHead && !reqHead.isEmpty()){
            ...
            responseBuilder.header("Access-Control-Allow-Headers",
                    "Cache-Control, Pragma, Origin, Authorization, Content-Type, X-Requested-With, Content-Range, Range, Accept-Ranges, Range-Unit");
        }

        responseBuilder.header("Access-Control-Expose-Headers", "Content-Range, Range, Accept-Ranges, Range-Unit");
