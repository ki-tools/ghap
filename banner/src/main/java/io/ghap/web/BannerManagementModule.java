...
import io.ghap.banner.dao.impl.DefaultHealthCheckDao;
...
import io.ghap.banner.domain.PersistFilter;
import io.ghap.banner.filter.LoggingFilter;
...
@DefaultBootstrap
public class BannerManagementModule extends JerseyServletModule {
